...
@Path("/")
@RequestScoped
public class HeavyWeaponary {

    private static Logger log = LoggerFactory.getLogger(HeavyWeaponary.class);
    ...
    @GET
    @Path("buckload")
    public Response buckload() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
